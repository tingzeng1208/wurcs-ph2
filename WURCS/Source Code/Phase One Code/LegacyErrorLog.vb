...
Public Class LegacyErrorLog

    Dim ConnString As String
    Dim dsErrors As DataTable

    Private Sub LegacyErrorLog_Load(ByVal sender As Object, ByVal e As EventArgs) Handles Me.Load
        ...
        'get rid of row column
        gv_Errors.RowHeadersVisible = False
        'appaearance constructs
