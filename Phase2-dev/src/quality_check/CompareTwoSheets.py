...
def compare_multiple_worksheets(comparisons: List[Tuple[str, str, str, str]],
                               **kwargs) -> List[Dict[str, Any]]:
    """
    Compare multiple worksheet pairs.
    
    Args:
        comparisons: List of tuples (wb1_path, ws1_name, wb2_path, ws2_name)
        **kwargs: Additional arguments passed to compare_worksheets()
    ...
    for i, (wb1_path, ws1_name, wb2_path, ws2_name) in enumerate(comparisons, 1):
        print(f"\n{'='*80}")
        print(f"COMPARISON {i} of {len(comparisons)}")
        print(f"{'='*80}")
        
        result = compare_worksheets(wb1_path, ws1_name, wb2_path, ws2_name, **kwargs)
        results.append(result)
    
    # Print overall summary
    print(f"\n{'='*80}")
    print(f"OVERALL SUMMARY - {len(comparisons)} comparisons")
    print(f"{'='*80}")
    
    total_comparisons = len([r for r in results if r.get("success")])
    perfect_matches = len([r for r in results if r.get("success") and r.get("different_cells", 0) == 0])
    
    print(f"Successful comparisons: {total_comparisons}")
    print(f"Perfect matches: {perfect_matches}")
    print(f"Comparisons with differences: {total_comparisons - perfect_matches}")
...
if __name__ == "__main__":
    ...
    source_wb1 = r"C:\Users\Ting.Zeng.ctr\Documents\WURCS-2025-project\development\Phase2-dev\reports\CN2023.xlsx"
    target_wb2 = r"C:\Users\Ting.Zeng.ctr\Documents\WURCS-2025-project\development\Phase2-dev\reports\CN-2023_report.xlsx"
    # target_wb2 = r"C:\Users\Ting.Zeng.ctr\Documents\WURCS-2025-project\development\Phase2-dev\reports\CN2023 - Copy-v2.xlsx"

    worksheet1_name = "A1P1"
    worksheet2_name = "A1P1"
